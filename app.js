...
let contract;
let accounts;
let contractOwnerAddress = '0x1A56608C8FcbdfA771878bA7126339CB66330580'; // Replace with your contract owner's address
const contractABI = [
	{
		"inputs": [],
...
const contractAddress = '0x2b3138F8196eb7f0e619E1CD715da6590b033a34'; // Replace with your contract's address
...
window.addEventListener('load', async () => {
    if (typeof window.ethereum !== 'undefined') {
        ...
        // Display sections based on the connected account
        document.getElementById('getPropertySection').style.display = 'block';

        if (accounts[0].toLowerCase() === contractOwnerAddress.toLowerCase()) {
